...
tf.app.flags.DEFINE_string('data_dir', r'C:\Users\Malcolm\Documents\GitHub\Roomba-Detection\roomba_data',
...
def distorted_inputs():
  ...
  images, labels = roomba_input.distorted_inputs(data_dir=data_dir,
